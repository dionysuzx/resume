...
- Backend database scaling with Kubernetes and PostgreSQL. Implemented elastic scaling to deal with spikey traffic (0 req/sec to 350 req/sec in less than a minute). We could've used a managed service but I implemented it in house which saved a lot of money.
- Backend microservice work in TypeScript (Express / Node.js). Frontend UI work in React.
- Wrote core microservice infra with Kubernetes, and much of the CI/CD with GitLab actions.
- Created an Engineering Handbook for the organization, trained and led engineers on how to do on-call duties. I developed standard operating procedures to help the engineering organization move more efficiently. This handbook is a career highlight because I poured my soul into it.
- Created a fun social bonding event for the team called "Fika"; once a week we got together just to drink coffee/tea and chill. :)
